...
@implementation OAuthXResponse

@synthesize rawData, service, httpURLResponse, jsonBody, xmlBody, stringBody;
...
- (id) parse:(NSError **)error {
    ...
    if ([result isKindOfClass:[NSDictionary class]]) {
        ...
        self.jsonBody = [NSDictionary dictionaryWithObjectsAndKeys: result, @"results", nil];
    }
    return result;
}
